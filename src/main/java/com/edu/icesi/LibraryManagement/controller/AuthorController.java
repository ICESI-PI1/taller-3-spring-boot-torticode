...
public class AuthorController {
    ...
    public Author showAuthor(@PathVariable("id") Long id, Model model){
    ...
    public Boolean uploadAuthor(@PathVariable("id") Long id, Author uploadAuthor){
    ...
    public List<Book> showBooksByAuthor(@RequestParam){
